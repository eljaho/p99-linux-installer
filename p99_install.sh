sudo apt-get install wine-stable winehq-stable fluidsynth qsynth fluid-soundfont-gm libglu1-mesa:i386 -y 	#Debian
#sudo dnf install wine-stable winehq-stable fluidsynth qsynth fluid-soundfont-gm libglu1-mesa:i386 -y 	Packages are incorrect #Fedora
#sudo pacman -S wine-stable winehq-stable fluidsynth qsynth fluid-soundfont-gm libglu1-mesa:i386 -y 	#Arch
